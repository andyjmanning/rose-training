...
window.ROSE_CONFIG = {
  ...
  courseVersion: "0.5 (draft)",

  // The source documents this course was built from.
  builtFrom: "Rose Cut-Over Process Guide V1.1 (18 Aug 2026), Rose Kitchen Printer Guide v2 (10 Aug 2026), and Celestra Whitbread Project SOW, 2 March 2026",
